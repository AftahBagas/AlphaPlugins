...
CLRS = {
        'red': 1, 'lime': 2, 'green': 3, 'blue': 4, 'cyan': 5, 'brown': 6,
        'purple': 7, 'pink': 8, 'orange': 9, 'yellow': 10, 'white': 11,
        'black': 12
       }


@userge.on_cmd("amongus", about={
    ...
    'color': "<code>-red ,  -lime ,  -green ,  -blue ,  -cyan ,  -brown ,  "
             ...
             "</code>",
    'examples': [
        "{tr}amongus call an emergency meeting",
        "{tr}amongus -red Sus"]})
    ...
    if message.flags:
        ...
        if choice not in list(CLRS):
            return await message.err(
                "Invalid color input ! See help for more info.",
                del_in=5
            )
        color = CLRS[choice]
    else:
